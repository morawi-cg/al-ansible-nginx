...
To start the process after cloning this repository, cd into it, then activate 'vagrant up' this should start the building of the vagrant boxes. Once done use 'ansible-playbook -i hosts site.yml  -vvvvv' This should install all needed components and get the system up and running.

I like to reflect maximum verbosity to help identify any issues and in full details. This is to help resolve quickly.
